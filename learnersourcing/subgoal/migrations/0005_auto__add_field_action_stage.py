...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Action.stage'
        db.add_column(u'subgoal_action', 'stage',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'subgoal_action', 'stage')
    ...
    models = {
        ...
        u'subgoal.step': {
            ...
            'learner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['subgoal.Learner']"}),
            'subgoal': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['subgoal.Subgoal']", 'null': 'True', 'blank': 'True'}),
